            ...
            <Card className="p-6 glass-effect">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+263780046554</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 glass-effect">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">4 Bannockburn close Mt pleasant, Harare</p>
                </div>
              </div>
            </Card>
          </div>
          ...
          <Card className="p-8 glass-effect">
            <form className="space-y-6">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full px-4 py-2 rounded-lg bg-background/50 border border-border text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent"
